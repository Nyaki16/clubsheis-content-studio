    ...
    styles: [
      {
        ...
        description: 'Kurzgesagt-style explainer — breaks a concept into clear animated scenes',
        defaults: {
          aspectRatio: '9:16',
          durationSeconds: 30,
        },
      },
      {
        id: 'promo',
        label: 'Promo / Hype',
        description: 'Punchy launch or offer video with bold motion and a strong CTA',
        defaults: {
          aspectRatio: '9:16',
          durationSeconds: 20,
        },
      },
      {
        ...
        description: 'Step-by-step walkthrough with flowcharts and numbered scenes',
        defaults: {
          aspectRatio: '9:16',
          durationSeconds: 40,
        },
      },
      {
        id: 'data-story',
        label: 'Data Story',
        description: 'Stat-led narrative with count-up numbers and diagrams',
        defaults: {
          aspectRatio: '1:1',
          durationSeconds: 30,
        },
